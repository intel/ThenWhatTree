...
output
------
This is a property of the base class and should be assigned with a string and not called.  The ‘output’ property is used to convey anything interesting about the node if it return ‘True’.  If the node returns ‘True’, the string assigned to ‘output’ will be printed in the output of the tree.  If the node returns ‘False’, the string assigned to ‘output’ will be dropped.  By default, the ‘output’ property is the name of the node appended with "is true".
...
---------------------------------
Method provided to set attributes of the node in the XML.  Attribute must already exist in the XML node or an exception will be raised.
...
These reserved words should not be used as column headers in a CSV file or as elements in an XML file
-node
-branch
...
CSV file description of the preceding block diagram.

sample_input.CSV
----------------
name,parent,notes
ROOT,,root node
NODE_A,,first child of ROOT
NODE_B,,only child of NODE_A
NODE_C,,first child of NODE_B
NODE_D,NODE_B,second child of NODE_b
NODE_E,ROOT,second child of ROOT
NODE_F,,first child of NODE_E
NODE_G,,first child of NODE_F
NODE_H,,first child of NODE_G
NODE_J,ROOT,third child of ROOT
NODE_K,NODE_E,second child of NODE_E
NODE_L,NODE_F,second child of NODE_F
NODE_M,NODE_G,second child of NODE_G
NODE_N,NODE_E,third child of NODE_E

XML generated from the preceding CSV file
...
<node>
    ...
    <node>
        <name>NODE_A</name>
        <parent/>
        <notes>first child of ROOT</notes>
        <node>
            <name>NODE_B</name>
            <parent/>
            <notes>only child of NODE_A</notes>
            <node>
                <name>NODE_C</name>
                <parent/>
                <notes>first child of NODE_B</notes>
            </node>
            <node>
                <name>NODE_D</name>
                <parent>NODE_B</parent>
                <notes>second child of NODE_b</notes>
            </node>
        </node>
    </node>
    <node>
        <name>NODE_E</name>
        <parent>ROOT</parent>
        <notes>second child of ROOT</notes>
        <node>
            <name>NODE_F</name>
            <parent/>
            <notes>first child of NODE_E</notes>
            <node>
                <name>NODE_G</name>
                <parent/>
                <notes>first child of NODE_F</notes>
                <node>
                    <name>NODE_H</name>
                    <parent/>
                    <notes>first child of NODE_G</notes>
                </node>
                <node>
                    <name>NODE_M</name>
                    <parent>NODE_G</parent>
                    <notes>second child of NODE_G</notes>
                </node>
            </node>
            <node>
                <name>NODE_L</name>
                <parent>NODE_F</parent>
                <notes>second child of NODE_F</notes>
            </node>
        </node>
        <node>
            <name>NODE_K</name>
            <parent>NODE_E</parent>
            <notes>second child of NODE_E</notes>
        </node>
        <node>
            <name>NODE_N</name>
            <parent>NODE_E</parent>
            <notes>third child of NODE_E</notes>
        </node>
    </node>
    <node>
        <name>NODE_J</name>
        <parent>ROOT</parent>
        <notes>third child of ROOT</notes>
    </node>
</node>

If the node library for this XML were created and the ‘execute_tree.py’ utility were run, the output might look something like this.  In this instance, I’ve arbitrarily forced some nodes to return ‘True’, some ‘False’, some aren’t implemented and I forced NODE_L to return 1/0.  The output comprised of 4 parts:

1) Annotated tree
2) Output properties of nodes that returned ‘True’
3) List of nodes that raised exceptions
...
[0] ROOT : true
    [1] NODE_A : true
        NODE_B : NotImplementedError
    [2] NODE_E : true
        [3] NODE_F : true
            [4] NODE_G : true
                NODE_H : false
                NODE_M : false
            NODE_L : ZeroDivisionError('division by zero',)
        NODE_K : NotImplementedError
        NODE_N : NotImplementedError
    NODE_J : false
...
[0] ROOT is true
[1] NODE_A is true
[2] Custom message added through ‘output’ property
[3] NODE_F is true
[4] NODE_G is true
...
Exception traceback:
--------------------
NODE_L: ['  File "<path>/.local/lib/python3.6/site-packages/ThenWhatTree-1.0-py3.6.egg/ThenWhatTree/lib/twt_node/ThenWhatTreeNode.py", line 83, in evaluate_node_is_true\n    node_is_true = str(self.is_true()).lower()\n', '  File "/tmp/ewberg/sample_CSV_lib/NODE_L.py", line 14, in is_true\n    return 1/0\n']
